                ...
                <table>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="file" class="form-control input_file" <?php if (empty($get_data->bukti_transfer)) {
                                                                                    echo 'required';
                                                                                } ?> name="gambar_1" onchange="change_image1(event)">
                            ...
                            <?php if (!empty($get_data->bukti_transfer)) { ?>
                                <a href="<?php echo base_url('component/bukti_pembayaran/' . $get_data->bukti_transfer) ?>" target="_blank">
                                    <img style="width:300px" id="output_image1" src="https://objectstorage.ap-melbourne-1.oraclecloud.com/n/axg2uln4zrfd/b/mrshop-bukti_pembayaran/o/<?php echo $get_data->bukti_transfer; ?>">
                                </a>
                            <?php } ?>
                            <br>
                    ...
                    <tr>
                        <td colspan="3">
                            <button type="submit" class="tombol-biru"><?php if ($get_data->status == 'Belum Dibayar') {
                                                                            echo 'Simpan';
                                                                        } else {
                                                                            echo 'Update';
                                                                        } ?></button>
